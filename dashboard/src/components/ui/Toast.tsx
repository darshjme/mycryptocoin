  ...
  return (
    <div
      className={`
        ...
        bg-[#1a1d2e]/95 backdrop-blur-xl border ${bgMap[toast.type]}
    ...
    >
      ...
      <button
        ...
        className="flex-shrink-0 p-1 rounded-md text-slate-500 hover:text-white hover:bg-white/5 transition-colors"
      >
